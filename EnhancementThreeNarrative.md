The artifact selected for this enhancement is the Animal Shelter Dashboard Application, originally developed in CS-340. This application was initially created as a Jupyter-notebook based dashboard that utilized MongoDB to store and retrieve animal shelter data. The dashboard allowed users to filter and visualize data related to animal types, rescue categories, and adoption status. 
...
One of the primary challenges I encountered was ensuring that database queries aligned correctly with the applications filtering requirements. The original implementation relied heavily on positional indexing and less efficient filtering logic. Transitioning to a more query-based approach required testing to ensure accuracy and reliability of results. 

Overall, this enhancement strengthened my understanding of how to design database-driven applications that are both functional and maintainable. It also reinforced the importance of aligning backend data structures with frontend application needs. These skills are directly applicable to my long-term goal of working in data analytics and artificial intelligence, where efficient data handling and processing are critical. 
